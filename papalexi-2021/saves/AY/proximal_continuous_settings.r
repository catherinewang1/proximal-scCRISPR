...
# should prob change proximal_continuous_settings to just proximal_settings... becaues they have both count and continuous settings
...
proximal_continuous_settings = list(
    ...
    'simpleCount'     = list(
      ...
      'proximalNegBinCountCount' = list( # NegBin Y, count NCE, count NCO (individual genes)
                  ...
                  num_NC_pairs = if(!is.null(default_num_NC_pairs)) default_num_NC_pairs else c(1, 3, 5, 8, 10),
                  # extra params for sparsePCA 
                  my_sumabsv   = NA, 
                  my_K         = NA,
                  N_subsample  = NA, 
