...
#                PERTURBATION_N_NONZERO_CELLS_MIN = 200 # grna_chr$n_nonzero min
# )

# Instead of settings here, put settings in separate R file and load in
...
# =================== Start ====================================================
print(sprintf("[%s] START: Choose AY", Sys.time()))
