...
# Continuous
# ========================================================================================================================================================================
# proximal_setting_name_continuous = 'SPCA8.0'
proximal_setting_name_continuous = 'SPCA34.5'
# proximal_setting_name_continuous = 'PCA'
plot_dir_continuous = sprintf('%s/AY/%s/%s/plots/', save_dir, AYZW_setting_name, proximal_setting_name_continuous) # create plot_dir (based on save_dir + settings)
...
effects_continuous = read.csv(sprintf('%s/AY/%s/%s/effects_continuous.csv', save_dir, AYZW_setting_name, proximal_setting_name_continuous))
...
effects_continuous$method_long = factor(effects_continuous$method_long, 
       levels = c( "lmYANA",                 "lmYAUNA" ,       "2SLSpci2s1",       "2SLSpci2s3",       "2SLSpci2s5",       "2SLSpci2s8",      "2SLSpci2s10",       "2SLSpci2s15",       "2SLSpci2s20"),
       labels = c("Lin Reg", "Lin Reg (w/ confounders)", "Proximal (#NC=1)", "Proximal (#NC=3)", "Proximal (#NC=5)", "Proximal (#NC=8)", "Proximal (#NC=10)", "Proximal (#NC=15)", "Proximal (#NC=20)"))
...
plot_dir_count = sprintf('%s/AY/%s/%s/plots/', save_dir, AYZW_setting_name, proximal_setting_name_count) # create plot_dir (based on save_dir + settings)
...
effects_count = read.csv(sprintf('%s/AY/%s/%s/effects_countGLM.csv', save_dir, AYZW_setting_name, proximal_setting_name_count))
...
plot_dir_all = sprintf('%s/AY/%s/%s/plotsAll/', save_dir, AYZW_setting_name, proximal_setting_name_continuous) # create plot_dir (based on save_dir + settings)
...
```{r}
print(sprintf('The proximal setting name is: %s', proximal_setting_name_continuous))
```
...
ggsave(sprintf('%s/time_hist.pdf', plot_dir_all), height = 4, width = 8)

p + scale_x_log10()
ggsave(sprintf('%s/time_hist_log.pdf', plot_dir_all), height = 4, width = 8)
