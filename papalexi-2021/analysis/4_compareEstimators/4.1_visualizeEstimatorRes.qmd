...
Histogram of Estimates
```{r fig.width=15, fig.height = 5}
ggplot(effects_continuous |> filter(is.na(numNC) | numNC %in% c(5, 10, 15, 20)),
       aes(x = ATE, fill = method_long)) +
...
ggsave(sprintf('%s/estimates_hist_2.pdf', plot_dir_all), height = 5, width= 16)
```


Histogram of p-values
```{r fig.width=15, fig.height = 5}
ggplot(effects |> filter(is.na(numNC) | numNC %in% c(5, 10, 15, 20)) |>
...
ggsave(sprintf('%s/pval_hist_2.pdf', plot_dir_all), height = 5, width= 25)
```
...
ggsave(sprintf('%s/pval_qqplot_2.pdf', plot_dir_all), height = 6, width = 7)
...
p
ggsave(sprintf('%s/pval_qqplot_log_best.pdf', plot_dir_all), height = 8, width= 8)
...
ggsave(sprintf('%s/pval_qqplot_log_tail_best.pdf', plot_dir_all), height = 8, width= 8)
