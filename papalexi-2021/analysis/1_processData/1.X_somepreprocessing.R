# preprocessing for papalexi-2021


# combine some prev scripts together so not as messy, maybe should still keep separate



print(sprintf("[%s] START: 1.X somethingsomething", Sys.time()))
...
#       <save_dir>/important_genes_idx.rds
#       <save_dir>/important_genes_name.rds
# ------------------------------------------------------------------------------------------------ #
...
########################################################################################################################
###   Remove Transcription Factor Genes 
########################################################################################################################
require(readxl) # load in excel xlsx format for TF list
...
########################################################################################################################
###   Normalize Gene Expr (counts --> continuous)
########################################################################################################################
