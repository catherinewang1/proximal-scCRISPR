...
suppressPackageStartupMessages(require(ondisc))
suppressPackageStartupMessages(require(tibble))
suppressPackageStartupMessages(library(dplyr))
suppressPackageStartupMessages(library(biomaRt))    # for pulling gene-chr info BiocManager::install("biomaRt")
...
# =================== Start ====================================================
print(sprintf("[%s] START: Get Chromosome Info", Sys.time()))
